<?php global $language ?>
<div class="function-room-module menu-scroll" data-scrollmenu-link-text="<?php echo t('Our Festive Experiences') ?>">
	<div class="container">
		<div class="row header">
			<div class="col-xs-12">
				<h2 class="module-heading"><?php echo t('Our Festive Experiences') ?></h2>
		...
		<div class="function-room-module-content container">
			<div class="function-room-tab" data-function-room-tabindex="1">
				...
				<div class="row">
					<div class="col-xs-12 text-center cta hidden-xs"><br />
						<?php echo t('To find out more about our festive experiences please click on more info') ?>
