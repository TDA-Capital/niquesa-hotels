	...
	<div class="col-xs-12 col-md-offset-4 col-md-4">
		<div class="row">
			<div class="col-xs-12 col-md-offset-1 col-md-10">
				...
				<div class="row">
					<?php if (isset($form['submitted']['property'])): ?>
						<div class="col-xs-6">
							<?php echo render($form['submitted']['property']) ?>
						</div>
					<?php endif ?>
					<div class="col-xs-6">
						<?php echo render($form['submitted']['function_room']) ?>
					</div>
				</div>
				<div class="row">
					<div class="col-xs-12">
						<?php echo render($form['submitted']['event_details']) ?>
					</div>
				</div>
				<?php 
