			...
			function setupOrigin(sk){
				...
				bubbleDiv.innerHTML = ['<div class="box-bg"><img src="'+origin.imgThumb+'"></div>',
											'<div class="bubble-text">',
												'<h4 class="single-line-text">'+origin.title+'</h4><hr class="horizontal-divider"><h5 class="single-line-text">'+origin.subTitle+'</h5>',
											'</div>'].join('');
				...
				thisOrigin.bubble = new InfoBox({
					...
					pixelOffset: new google.maps.Size(-150, -280), //new google.maps.Size(1, 1),
					visible: true,
					closeBoxMargin: "0px",
				...
				//google.maps.event.addListener(thisOrigin.bubble.bubble_, 'click', function(x) { console.log("wtf");}); //WHYTEHFUCKWONTYOUWORK?!?!?!?!?!
				//$(thisOrigin.bubble.bubble_).click(function(){google.maps.event.trigger(thisOrigin.mark, 'click')});
